...
public class BenMonroLC {
			...
			public static void main(String[] args) throws InterruptedException, Exception {
				...
				driver.findElement(By.xpath("//input[@name='Title']")).sendKeys("Co-Owner");
				driver.findElement(By.xpath("//input[@name='Email']")).sendKeys("benmonro@ewh.ca");
				driver.findElement(By.xpath("//input[@name='Website']")).sendKeys("excellentwarehouses.com");
				driver.findElement(By.xpath("//input[@name='AnnualRevenue']")).sendKeys("$32375645");
				...
				System.out.println( "                     ");
				System.out.println( "Lead-Ben Monro is created successfully.");
				System.out.println( "The Lead Url is " + Leadurl);
           
				WebElement LeadName = driver.findElement(By.linkText("Ben Monro"));				
				System.out.println(" New Lead is created with name as " + LeadName);
				driver.close();
